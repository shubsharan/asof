  ...
  hypotheses: [
    {
      ...
      status: "untested",
      history: [
        { asOf: "2026-03-01T15:00:00Z", confidence: 81, status: "supported", reasoning: "", evidenceIds: ["seed-stage"] },
        { asOf: "2026-09-20", confidence: 58, status: "at-risk", reasoning: "", evidenceIds: ["series-b"] },
      ],
    ...
    },
    {
      ...
      status: "untested",
      history: [{ asOf: "2026-06-01", confidence: 70, status: "supported", reasoning: "", evidenceIds: ["x"] }],
      evidence: [],
    },
  ],
};
